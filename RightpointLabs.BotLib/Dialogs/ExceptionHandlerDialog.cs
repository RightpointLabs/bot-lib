...
{
    /// <summary>
    /// Wrapper dialog that will catch exceptions, track them, and optionally display them to the user
    /// </summary>
    ...
    public class ExceptionHandlerDialog<T> : IDialog<object>
    {
        ...
        protected async virtual Task DisplayException(IDialogContext context, Exception e)
        {
